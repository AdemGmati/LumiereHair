    ...
    <div className={cn('flex flex-col gap-6', className)} {...props}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t('auth.loginSubtitle') as string}</CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  >
                    {t('common.forgotPassword') as string}
                  </Link>
                </div>
                <Input
                  id="password"
              ...
              <Button type="submit" className="w-full" disabled={isLoading}>
                {isLoading ? t('auth.loggingIn') as string : t('auth.loginTitle') as string}
              </Button>
            </div>
            <div className="mt-4 text-center text-sm">
              {t('common.dontHaveAccount') as string}{' '}
